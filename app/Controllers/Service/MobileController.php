...
class MobileController extends ServiceController {
    ...
    function nhanviec() {
        ...
        if (empty($bided)) {
            ...
            if (Bid::SaveData($postData)) {
                ...
                $this->message = 'Success';
                Booking::SaveData(['id' => $postData['booking_id'], 'status' => 1]);
                $push_data = Customer::getCustomerById($postData['laodong_id']);
    ...
    function naptien() {
        ...
        $checkCustomer = Customer::getCustomerById($post['customer_id']);
    ...
    function lichsugiaodich() {
        $this->checkNullData(Input::get('customer_id'));
        $checkCustomer = Customer::getCustomerById(Input::get('customer_id'));
