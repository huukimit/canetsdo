...
@section('main')
<form id="changepassword_useradmin" class="form-horizontal" name="change_password" accept-charset="UTF-8" action="{{URL::to('admin/idols/changepassword')}}" method="POST">
    <div class="row panel">
        <div class="col-sm-10">
            ...
            <div class="form-group">
                <div class="col-sm-9 col-sm-offset-4">
                    <a href="{{URL::to('admin/idols/detail?id='.$getData['id'])}}" class="btn btn-default btn-labeled fa fa-arrow-left fa-lg">戻る</a>
