            ...
            <div class="header">
                <div class="header_logo">
                    <div class="header_logo_img">
                        <a href="#">
                            <img src="img/logo.png" alt="" class="img img-responsive">
                        </a>
                    </div>
                </div>
            ...
            <div class="video">
                <div class="v_video">
                    <div class="video_text">
                        <h1>Đăng ký công việc tại chỗ, lựa chọn ứng viên phù hợp</h1>
                        <p>Canets sự lựa chọn tốt nhất của bạn!</p>
                        <p>Hãy thử và tự cảm nhận...</p>
                    </div>
            ...
            <div class="section_two">
                <div class="section_two_item">
                    <div class="section_two_item_img">
                        <a href="#"><img src="img/furture_1.png" class="img img-responsive" alt=""></a>
                    </div>
                </div>

                <div class="section_two_item">
                    <div class="section_two_item_img">
                        <a href="#"><img src="img/furture_2.png" class="img img-responsive" alt=""></a>
                    </div>
                </div>

                <div class="section_two_item">
                    <div class="section_two_item_img">
                        <a href="#"><img src="img/furture_3.png" class="img img-responsive" alt=""></a>
                    </div>
                </div>

                <div class="section_two_item">
                    <div class="section_two_item_img">
                        <a href="#"><img src="img/furture_4.png" class="img img-responsive" alt=""></a>
                    </div>
                </div>
        ...
        <div class="my_container">
            ...
            <div class="stt_one" id="step_1" hidden="">
                <div class="stt_one_left">
                    <img src="img/step1.png" class="img img-responsive steps" alt="">
                </div>
            ...
            <div class="stt_one" id="step_2" hidden="">
                <div class="stt_one_left">
                    <img src="img/step2.png" class="img img-responsive steps" alt="">
                </div>
                <div class="stt_one_right">
            ...
            <div class="stt_one" id="step_3" hidden="">
                <div class="stt_one_left">
                    <img src="img/step3.png" class="img img-responsive steps" alt="">
                </div>
                <div class="stt_one_right">
            ...
            <div class="stt_one" id="step_4" hidden="">
                <div class="stt_one_left">
                    <img src="img/step4.png" class="img img-responsive steps" alt="">
                </div>
                <div class="stt_one_right">
