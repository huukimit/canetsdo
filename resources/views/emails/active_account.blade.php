...
<body>
  <div style="background-color:#fff;margin:0 auto 0 auto;padding:30px 0 30px 0;color:#4f565d;font-size:13px;line-height:20px;font-family:'Helvetica Neue',Arial,sans-serif;text-align:left;">
    <center>
      <table  style="width:600px;text-align:center;border: 1px solid #30A5FF;border-radius:5px; padding:30px;">
        <tbody>
          <tr>
          ...
          <tr>
            <td colspan="2" style="padding:30px 0;">
              ...
              <p>
                <a style="display:inline-block;text-decoration:none;padding:15px 20px;background-color:#2baaed;border:1px solid #2baaed;border-radius:3px;color:#FFF;font-weight:bold;" href="/confirmemail/{{$forgot_password}}" target="_blank">Xác nhận email đăng ký</a>
              </p>
            </td>
          </tr>
          <tr>
